from seleniumwire.proxy import controller  # noqa
from seleniumwire.proxy import connections, exceptions
from seleniumwire.proxy.server import config  # noqa
...
class _LayerCodeCompletion:
    ...
    def __init__(self, **mixin_args):  # pragma: no cover
        ...
        self.ctx = None
        """@type: seleniumwire.proxy.server.protocol.Layer"""
...
class Layer(_LayerCodeCompletion):
    ...
    def __init__(self, ctx, **mixin_args):
        ...
        The root layer is passed a :py:class:`seleniumwire.proxy.server.RootContext` object,
        which provides access to :py:attr:`.client_conn <seleniumwire.proxy.server.RootContext.client_conn>`,
        :py:attr:`.next_layer <seleniumwire.proxy.server.RootContext.next_layer>` and other basic attributes.
    ...
    def __call__(self):
        ...
        Raises:
            ~seleniumwire.proxy.exceptions.ProtocolException: if an exception occurs. No other exceptions must be raised.
        """
...
class ServerConnectionMixin:
    ...
    def connect(self):
        ...
        Raises:
            ~seleniumwire.proxy.exceptions.ProtocolException: if the connection could not be established.
        """
