from seleniumwire.proxy import exceptions, log
from seleniumwire.proxy.net import tls
from seleniumwire.proxy.server import modes, protocol
from seleniumwire.proxy.server.protocol import http
...
class RootContext:
    ...
    Attributes:
        client_conn:
            The :py:class:`client connection <seleniumwire.proxy.connections.ClientConnection>`.
        channel:
            A :py:class:`~seleniumwire.proxy.controller.Channel` to communicate with the FlowMaster.
            Provides :py:meth:`.ask() <seleniumwire.proxy.controller.Channel.ask>` and
            :py:meth:`.tell() <seleniumwire.proxy.controller.Channel.tell>` methods.
        config:
            The :py:class:`proxy server's configuration <seleniumwire.proxy.server.ProxyConfig>`
    """
