...
from seleniumwire.proxy import connections, exceptions, flow, http, log, platform
from seleniumwire.proxy.net import tcp
from seleniumwire.proxy.net.http import http1
from seleniumwire.proxy.server import config, modes, root_context
...
class ConnectionHandler:
    ...
    def __init__(self, client_conn, client_address, config, channel):
        ...
        self.client_conn = connections.ClientConnection(
            ...
            client_address,
            None)
        """@type: seleniumwire.proxy.server.connection.ClientConnection"""
        self.channel = channel
        """@type: seleniumwire.proxy.controller.Channel"""
