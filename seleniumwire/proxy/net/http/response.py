...
from seleniumwire.proxy.net.http import cookies, message, status_codes
from seleniumwire.proxy.net.http.headers import Headers
from seleniumwire.proxy.utils import human, strutils
from seleniumwire.proxy.utils.strutils import always_bytes
...
class Response(message.Message):
    ...
    def cookies(self) -> multidict.MultiDictView:
        ...
        :py:class:`~seleniumwire.proxy.net.multidict.MultiDictView`, where the keys are cookie
