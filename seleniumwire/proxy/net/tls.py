...
import seleniumwire.proxy.options
from seleniumwire.proxy import certs, exceptions
from seleniumwire.proxy.contrib.kaitaistruct import tls_client_hello
from seleniumwire.proxy.net import check
...
def client_arguments_from_options(options: "seleniumwire.proxy.options.Options") -> dict:
...
class ClientHello:
    ...
    def from_file(cls, client_conn) -> "ClientHello":
        ...
        client_conn:
            The :py:class:`client connection <seleniumwire.proxy.connections.ClientConnection>`.
        Returns:
            :py:class:`client hello <seleniumwire.proxy.net.tls.ClientHello>`.
        """
        try:
